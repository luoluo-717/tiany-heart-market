...
elseif 地图ID == 1580 then
		假人[1]={名称="刑天",称谓 = '师门任务',模型="刑天",X=95,方向=1,Y=82,执行事件="不执行",小地图名称颜色=0}
		假人[2]={名称="雨师妾",模型="雨师妾",X=57,方向=0,Y=107,执行事件="不执行",小地图名称颜色=0}
		假人[3]={名称="风祖飞廉",称谓 = '传送长安',模型="风祖飞廉",X=76,方向=1,Y=78,执行事件="不执行",小地图名称颜色=0}
		假人[4]={名称="食铁兽",模型="食铁兽",X=40,方向=0,Y=71,执行事件="不执行",小地图名称颜色=0}
		-- 假人[1]={名称="蚩尤幻影",模型="蚩尤",X=68,方向=0,Y=26,执行事件="不执行",小地图名称颜色=0}
	...
	elseif 地图ID == 1501 then--建邺城
		...
		假人[37] = {名称="桃气炼丹师",模型="炼丹童子",X=194,Y=121,方向=1,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
	...
	elseif 地图ID == 1208 then
		...
		假人[10] = {名称="土地公公",模型="男人_土地",X=21,Y=25,方向=0,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
		假人[11] = {名称="妖魔亲信",模型="蝴蝶仙子",X=96,Y=40,方向=1,变异=true,事件ID=nil,执行事件="不执行",小地图名称颜色=5}
	...
	elseif 地图ID == 1040 then--西凉女国
		...
		假人[11] = {名称="幻梦仙子",模型="普陀_接引仙女",X=85,Y=62,方向=0,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
	...
	elseif 地图ID == 1226 then
		...
		-- 假人[6] = {名称="霓裳姑娘",称谓="梦幻锦衣",模型="女人_万圣公主",X=39,Y=86,方向=0,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
		假人[21] = {名称="叶法善",称谓="慈心渡鬼",模型="男人_诗中仙",X=92,Y=15,方向=0,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
	...
	elseif 地图ID == 1502 then
		假人[1] = {名称="武器店老板",模型="男人_武器店老板",X=22,Y=18,方向=0,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
    ...
    elseif 地图ID == 1126 then
		假人[1] = {名称="接引小仙",称谓="传送女魃墓",模型="女人_万圣公主",X=185,Y=17,方向=1,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
	...
	elseif 地图ID == 1110 then
		...
		假人[15] = {名称="花铃",称谓="青丘迷雾",模型="进阶花铃",X=178,Y=302,方向=1,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
	...
	elseif 地图ID == 1001 then
		...
		-- 假人[33] = {名称="明月楼右护法",模型="剑侠客",称谓="不负红尘百般缘",武器="冷月",X=417,Y=63,方向=0,染色方案=2,染色组={3,3,3},事件ID=nil,执行事件="不执行"}
		...
		假人[37] = {名称="决战大雁塔使者",模型="男人_将军",X=431,Y=43,方向=1,事件ID=nil,执行事件="不执行",小地图名称颜色=6}

		假人[38] = {名称="传令天兵",模型="天兵",称谓="神器任务",显示饰品=true,X=245,Y=109,方向=1,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
		...
		-- 假人[78] = {名称="元宵使者",模型="女人_灵鼠娃娃",X=229,Y=102,方向=1,事件ID=nil,执行事件="不执行",小地图名称颜色=0} --有对话
		...
		-- 假人[81] = {名称="异兽使",模型="雾中仙",称谓="异兽使者",X=233,Y=161,方向=1,事件ID=nil,执行事件="不执行",小地图名称颜色=0} --有对话
		...
		假人[96] = {名称="秃头魔导师",模型="灵灯侍者",X=224,Y=130,方向=0,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
  ...
  --   		假人[95] = {名称="超级神猪使者",模型="超级神猪",称谓="神兽",X=390,Y=50,方向=0,事件ID=nil,执行事件="不执行"}
		...
		假人[106] = {名称="三界包打听",模型="男人_诗中仙",称谓="三界包打听",X=225,Y=100,方向=0,事件ID=nil,执行事件="不执行"} --有对话
		...
		假人[135] = {名称="燕赤侠",模型="至尊宝",称谓="妖王争霸赛",X=255,Y=113,方向=1,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
		...
		假人[144] = {名称="戴胄",模型="考官2",X=150,Y=96,方向=1,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
		...
		假人[145]={名称="镇塔童子",模型="小魔头",称谓="挑战镇妖塔",X=239,显示饰品=true,方向=1,Y=105,执行事件="不执行",小地图名称颜色=3,商业分类1=0,商业分类2=0,商业分类3=0,商业分类4=0}
		假人[146] = {名称="采矿大师",模型="男人_武器店老板",X=218,Y=110,方向=0,事件ID=nil,执行事件="不执行",小地图名称颜色=0,商业分类1=0,商业分类2=0,商业分类3=0,商业分类4=0}
		假人[147] = {名称="超级神柚",模型="超级神柚",称谓="超级技能赐福",X=400,Y=67,方向=0,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
		假人[148] = {名称="辰年上卿",称谓="龙年福利任务",模型="考官2",X=227,Y=106,方向=0,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
		假人[149] = {名称="小芙",模型="长乐灵仙",称谓="传送芙蓉园",X=417,Y=9,方向=1,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
        假人[152] = {名称="GM挑战使者",模型="剑侠客",X=393,Y=69,锦衣="浮生绡·点黛",方向=0,武器="鸣鸿",事件ID=nil,执行事件="不执行",小地图名称颜色=6}
        假人[153] = {名称="GM挑战使者",模型="飞燕女",X=403,Y=63,锦衣="浮生绡·点黛",方向=0,武器="紫电青霜",事件ID=nil,执行事件="不执行",小地图名称颜色=6}
		假人[154] = {名称="会员使者",模型="龙太子",X=210,Y=114,染色方案=10,染色组={3,3,4},锦衣="小福兔·月白",方向=0,武器="天龙破城",事件ID=nil,执行事件="不执行",小地图名称颜色=6}
		假人[155] = {名称="嘉年华活动",模型="进阶长乐灵仙",称谓="新春嘉年华",X=249,Y=116,方向=0,事件ID=nil,执行事件="不执行"}
        -- 假人[156] = {名称="赌狗",称谓="赌狗",模型="赌徒",X=228,Y=111,方向=0,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
		假人[157] = {名称="仙玉交易公证员",模型="男人_老书生",称谓="财源广进",X=217,Y=104,方向=0,事件ID=nil,执行事件="不执行",小地图名称颜色=0} ----------佬伍修改（增加仙玉寄售功能）
		假人[158] = {执行事件= "不执行",Y=128,方向=2,X=236,小地图名称颜色 = 0,显示饰品=true,模型="男人_老书生",名称="人族秘境使者",称谓="难度挑战"}-------------佬伍修改（增加种族秘境时空之钥）
        假人[159] = {执行事件= "不执行",Y=125,方向=2,X=243,小地图名称颜色 = 0,显示饰品=true,模型="巫师",名称="魔族秘境使者",称谓="难度挑战"}-------------佬伍修改（增加种族秘境时空之钥）
        假人[160] = {执行事件= "不执行",Y=122,方向=2,X=249,小地图名称颜色 = 0,显示饰品=true,模型="南极仙翁",名称="仙族秘境使者",称谓="难度挑战"}-------------佬伍修改（增加种族秘境时空之钥）
		假人[161] = {名称="阵营选择",称谓="双龙之战玩法",模型="剑侠客",武器="魏武青虹",锦衣="小福兔·月白",染色方案=2,染色组={3,3,3},X=224,Y=118,方向=0,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
        假人[162] = {名称="深海恶蛟",称谓="双龙之战挑战",模型="蛟龙",显示饰品=true,X=215,Y=122,方向=0,事件ID=nil,执行事件="不执行",小地图名称颜色=5}
		假人[163] = {名称="薛礼",称谓="盘龙岛挑战",模型="薛礼",X=232,Y=114,方向=0,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
		假人[165] = {名称="女娲神使",模型="进阶灵符女娲",称谓="玉魄使者",X=136,Y=91,方向=0,事件ID=nil,执行事件="不执行"}
	elseif 地图ID == 2574 then
		假人[1] = {名称="怒蛟",模型="怒蛟BOSS",X=75,Y=28,方向=1,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
		--覆海帮
		-------------------------C改双龙
 	elseif 地图ID == 1574 then
		假人[1] = {名称="蛟魔王",模型="蛟魔王",称谓="阵营任务",显示饰品=true,X=141,Y=77,方向=0,事件ID=nil,执行事件="不执行",小地图名称颜色=5}
		假人[2] = {名称="黑水随从",模型="鲛人",称谓="皮皮龙训练",X=130,Y=70,方向=0,事件ID=nil,执行事件="不执行",小地图名称颜色=5}
		假人[3] = {名称="覆海军师",模型="鼠先锋",称谓="阵营职位",X=123,Y=81,方向=0,事件ID=nil,执行事件="不执行",小地图名称颜色=5}
		假人[4] = {名称="万圣公主",模型="女人_万圣公主",称谓="好感礼物制造",X=149,Y=70,方向=0,事件ID=nil,执行事件="不执行",小地图名称颜色=5}
		假人[5] = {名称="暮烟仙姑",模型="少女",X=80,Y=71,方向=2,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
		假人[6] = {名称="虎魄神君",模型="进阶噬天虎",X=50,Y=72,方向=2,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
		假人[7] = {名称="仙鹤使者",模型="进阶蛟龙",X=29,Y=60,方向=3,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
		假人[8] = {名称="紫霄老祖",模型="雨师",X=24,Y=39,方向=2,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
		假人[9] = {名称="幽谷幻影",模型="蜃气妖",X=43,Y=29,方向=2,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
		假人[10] = {名称="猪鬃道士",模型="野猪精",X=66,Y=78,方向=2,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
		假人[11] = {名称="清姑",模型="灵符女娲",X=76,Y=20,方向=0,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
		假人[12] = {名称="星老",模型="进阶风伯",X=115,Y=31,方向=0,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
		假人[13] = {名称="夜行孤者",模型="进阶古代瑞兽",X=130,Y=44,方向=1,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
		假人[14] = {名称="流云仙子",模型="曼珠沙华",X=92,Y=45,方向=0,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
		假人[15] = {名称="逐影",模型="进阶天将",X=77,Y=48,方向=0,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
		假人[16] = {名称="雷霆剑客",模型="剑侠客",武器="青锋剑",X=62,Y=47,方向=0,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
            --四海龙宫
 	elseif 地图ID == 1573 then
		假人[1] = {名称="灵汐公主",模型="司辰侍者过去",称谓="阵营任务",X=83,Y=56,方向=0,显示饰品=true,事件ID=nil,执行事件="不执行",小地图名称颜色=5}
		假人[2] = {名称="小龙女",模型="小龙女",称谓="皮皮龙训练",X=69,Y=43,方向=0,事件ID=nil,执行事件="不执行",小地图名称颜色=5}
		假人[3] = {名称="摩昂太子",模型="进阶蛟龙",称谓="阵营职位",X=80,Y=40,方向=0,事件ID=nil,执行事件="不执行",小地图名称颜色=5}
		假人[4] = {名称="北海龙王",模型="东海龙王",称谓="好感礼物制造",X=54,Y=51,方向=0,事件ID=nil,执行事件="不执行",小地图名称颜色=5}
		假人[5] = {名称="暮烟仙姑",模型="少女",X=2,Y=42,方向=2,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
		假人[6] = {名称="虎魄神君",模型="进阶噬天虎",X=18,Y=67,方向=2,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
		假人[7] = {名称="仙鹤使者",模型="进阶蛟龙",X=28,Y=57,方向=3,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
		假人[8] = {名称="紫霄老祖",模型="雨师",X=24,Y=39,方向=2,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
		假人[9] = {名称="幽谷幻影",模型="蜃气妖",X=43,Y=29,方向=2,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
		假人[10] = {名称="猪鬃道士",模型="野猪精",X=66,Y=78,方向=2,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
		假人[11] = {名称="清姑",模型="灵符女娲",X=77,Y=8,方向=0,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
		假人[12] = {名称="星老",模型="进阶风伯",X=94,Y=16,方向=0,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
		假人[13] = {名称="夜行孤者",模型="进阶古代瑞兽",X=97,Y=35,方向=1,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
		假人[14] = {名称="流云仙子",模型="曼珠沙华",X=72,Y=38,方向=0,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
		假人[15] = {名称="逐影",模型="进阶天将",X=77,Y=48,方向=0,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
		假人[16] = {名称="雷霆剑客",模型="剑侠客",武器="青锋剑",X=62,Y=47,方向=0,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
	elseif 地图ID == 11181 then--
 		假人[1] = {名称="皓月",模型="虾兵",称谓="阵营NPC",X=5,Y=12,方向=0,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
		假人[2] = {名称="玉游",模型="金身罗汉",称谓="阵营NPC",X=25,Y=19,方向=0,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
		假人[3] = {名称="火焰灵",模型="凤凰",称谓="阵营NPC",X=56,Y=26,方向=1,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
		假人[4] = {名称="红尘老",模型="进阶风伯",称谓="阵营NPC",X=50,Y=42,方向=2,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
		假人[5] = {名称="影月狼",模型="幽灵",称谓="阵营NPC",X=14,Y=40,方向=0,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
		假人[6] = {名称="花间妖",模型="花妖",称谓="阵营NPC",X=45,Y=30,方向=0,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
 		假人[7] = {名称="海妖大王",模型="进阶镜妖",称谓="每日挑战海妖大王",X=28,Y=8,方向=0,事件ID=nil,执行事件="不执行",小地图名称颜色=0}

 	elseif 地图ID == 11191 then--
                       假人[1] = {名称="蛙鸣智者",模型="月光雪蛙",称谓="阵营NPC",X=5,Y=21,方向=0,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
                       假人[2] = {名称="风舞神灵",模型="律法女娲",称谓="阵营NPC",X=50,Y=37,方向=1,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
                       假人[3] = {名称="竹韵诗人",模型="超级大熊猫",称谓="阵营NPC",X=53,Y=22,方向=0,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
                       假人[4] = {名称="霓裳歌姬",模型="司辰侍者(未来)",称谓="阵营NPC",X=34,Y=8,方向=0,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
                       假人[5] = {名称="竹影道士",模型="小毛头",称谓="阵营NPC",X=10,Y=14,方向=0,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
                       假人[6] = {名称="霞光游者",模型="小龙女",称谓="阵营NPC",X=23,Y=15,方向=0,事件ID=nil,执行事件="不执行",小地图名称颜色=0}

 	elseif 地图ID == 11201 then--
 		假人[1] = {名称="幽蓝女神",模型="司风",称谓="阵营NPC",X=13,Y=9,方向=0,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
 		假人[2] = {名称="迷雾",模型="骷髅怪",称谓="阵营NPC",X=52,Y=10,方向=1,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
 		假人[3] = {名称="猕猴",模型="超级六耳猕猴",称谓="阵营NPC",X=10,Y=20,方向=0,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
 		假人[4] = {名称="青藤",模型="超级神猴",称谓="阵营NPC",X=33,Y=43,方向=1,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
 		假人[5] = {名称="苍穹",模型="马猴",称谓="阵营NPC",X=3,Y=35,方向=0,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
 		假人[6] = {名称="星辰",模型="狂豹人形",称谓="阵营NPC",X=53,Y=35,方向=3,事件ID=nil,执行事件="不执行",小地图名称颜色=0}

 	elseif 地图ID == 11211 then--
 		假人[1] = {名称="火焰神灵",模型="进阶凤凰",称谓="阵营NPC",X=33,Y=22,方向=0,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
 		假人[2] = {名称="风铃",模型="芙蓉仙子",称谓="阵营NPC",X=12,Y=17,方向=1,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
 		假人[3] = {名称="夜雨道长",模型="持国巡守",称谓="阵营NPC",X=52,Y=13,方向=3,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
 		假人[4] = {名称="月影",模型="月影仙",称谓="阵营NPC",X=32,Y=8,方向=3,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
 		假人[5] = {名称="紫霄",模型="夜罗刹",称谓="阵营NPC",X=7,Y=10,方向=0,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
 		假人[6] = {名称="碧海",模型="大力金刚",称谓="阵营NPC",X=12,Y=32,方向=3,事件ID=nil,执行事件="不执行",小地图名称颜色=0}

 	elseif 地图ID == 15321 then--
 		假人[1] = {名称="碧云仙子",模型="红萼仙子",称谓="阵营NPC",X=36,Y=10,方向=0,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
 		假人[2] = {名称="妖姬",模型="超级神鸡",称谓="阵营NPC",X=55,Y=39,方向=1,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
 		假人[3] = {名称="雷霆",模型="黑熊精",称谓="阵营NPC",X=50,Y=14,方向=1,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
 		假人[4] = {名称="雪域神灵",模型="小仙女",称谓="阵营NPC",X=10,Y=34,方向=3,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
 		假人[5] = {名称="追梦猎手",模型="巡游天神",称谓="阵营NPC",X=38,Y=42,方向=2,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
 		假人[6] = {名称="雪舞",模型="蝎子精",称谓="阵营NPC",X=17,Y=4,方向=1,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
 	elseif 地图ID == 11261  then
		假人[1]={名称="海底猪妖",模型="野猪",称谓="海底秘境第一关",X=84,方向=0,Y=79,执行事件="不执行",小地图名称颜色=0}
		假人[2]={名称="海底虎怪",模型="老虎",称谓="海底秘境第二关",X=98,方向=1,Y=77,执行事件="不执行",小地图名称颜色=0}
		假人[3]={名称="羊怪冤魂",模型="羊头怪",称谓="海底秘境第三关",X=110,方向=0,Y=81,执行事件="不执行",小地图名称颜色=0}
		假人[4]={名称="花妖冤魂",模型="花妖",称谓="海底秘境第四关",X=117,方向=2,Y=70,执行事件="不执行",小地图名称颜色=0}
		假人[5]={名称="猴精冤魂",模型="超级六耳猕猴",称谓="海底秘境第五关",X=86,方向=3,Y=56,执行事件="不执行",小地图名称颜色=0}
		假人[6]={名称="锢魂精怪",模型="骷髅怪",称谓="海底秘境第六关",X=101,方向=1,Y=55,执行事件="不执行",小地图名称颜色=0}
		假人[7]={名称="巡逻虾兵",模型="虾兵",称谓="海底秘境第七关",X=128,方向=0,Y=57,执行事件="不执行",小地图名称颜色=0}
		假人[8]={名称="巡逻蟹怪",模型="蟹将",称谓="海底秘境第八关",X=157,方向=3,Y=56,执行事件="不执行",小地图名称颜色=0}
		假人[9]={名称="巡逻海龟",模型="龟丞相",称谓="海底秘境第九关",X=151,方向=0,Y=67,执行事件="不执行",小地图名称颜色=0}
		假人[10]={名称="蚌精守卫",模型="蚌精",称谓="海底秘境第十关",X=178,方向=1,Y=79,执行事件="不执行",小地图名称颜色=0}
		假人[11]={名称="鲛人守卫",模型="鲛人",称谓="海底秘境第十一关",X=173,方向=1,Y=49,执行事件="不执行",小地图名称颜色=0}
		假人[12]={名称="龙女守将",模型="小龙女",称谓="海底秘境第十二关",X=182,方向=1,Y=22,执行事件="不执行",小地图名称颜色=0}
		假人[13]={名称="水族精兵",模型="虾兵",称谓="海底秘境第十三关",X=157,方向=1,Y=34,执行事件="不执行",小地图名称颜色=0}
		假人[14]={名称="东海校尉",模型="碧水夜叉",称谓="海底秘境第十四关",X=122,方向=2,Y=35,执行事件="不执行",小地图名称颜色=0}
		假人[15]={名称="龙宫督军",模型="无名",称谓="海底秘境第十五关",X=122,方向=0,Y=16,执行事件="不执行",小地图名称颜色=0}
		假人[16]={名称="伏波将军",模型="薛礼",称谓="海底秘境第十六关",X=103,方向=3,Y=29,执行事件="不执行",小地图名称颜色=0}
		假人[17]={名称="踏浪元帅",模型="雨师",称谓="海底秘境第十七关",X=100,方向=0,Y=14,执行事件="不执行",小地图名称颜色=0}
		假人[18]={名称="龙卫军头领",模型="蛟龙",称谓="海底秘境第十八关",X=83,方向=0,Y=14,执行事件="不执行",小地图名称颜色=0}
		假人[19]={名称="龙宫公主",模型="进阶龙鲤",称谓="海底秘境第十九关",X=36,方向=1,Y=13,执行事件="不执行",小地图名称颜色=0}
		假人[20]={名称="龙宫驸马",模型="进阶蛟龙",称谓="海底秘境第二十关",X=20,方向=0,Y=14,执行事件="不执行",小地图名称颜色=0}
		假人[21]={名称="勇武龙子",模型="龙太子",称谓="海底秘境二十一关",武器="梨花",X=11,方向=0,Y=26,执行事件="不执行",小地图名称颜色=0}
		假人[22]={名称="多谋龙孙",模型="龙太子",锦衣="青花瓷",称谓="海底秘境二十二关",武器="弑皇",X=8,方向=3,Y=40,执行事件="不执行",小地图名称颜色=0}
		假人[23]={名称="龙宫龙王",模型="东海龙王",称谓="海底秘境二十三关",X=20,方向=3,Y=49,执行事件="不执行",小地图名称颜色=0}
		假人[24]={名称="灵感大王",模型="进阶天兵",称谓="海底秘境二十四关",X=45,方向=1,Y=37,执行事件="不执行",小地图名称颜色=0}
		假人[25]={名称="蜃气妖分身",模型="进阶蜃气妖",称谓="海底秘境二十五关",X=29,方向=0,Y=30,执行事件="不执行",小地图名称颜色=0}
		-------------------------C改双龙
	...
	elseif 地图ID == 1028 then
		...
		假人[2] = {名称="酒店老板",模型="男人_酒店老板",X=38,Y=32,方向=1,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
	-- 大唐官府
	...
	elseif 地图ID == 1092 then
		...
		假人[16] = {名称="咸鱼补梦使",模型="进阶凤凰",X=118,Y=22,方向=0,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
	...
	elseif 地图ID == 1111 then
		...
		假人[5] = {名称="千里眼",模型="天兵",X=232,Y=22,方向=0,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
		...
		假人[14] = {名称="叽呱冒险家",模型="进阶有苏鸩",X=114,Y=149,方向=0,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
	...
	elseif 地图ID == 1218 then
		...
		假人[2] = {名称="莫守",称谓="墨家机关",模型="机关人人形",X=51,Y=117,方向=1,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
	...
	elseif 地图ID == 1070 then
		...
		假人[25] = {名称="笑面讨债鬼",模型="进阶独角鬼王",X=140,Y=80,方向=0,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
	...
	elseif 地图ID == 1205 then
		假人[1] = {名称="蚩尤元神",模型="蚩尤",X=51,Y=44,方向=0,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
		假人[2] = {名称="武神坛传送",模型="巫师",X=59,Y=41,方向=1,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
		假人[3] = {名称="巫师",模型="巫师",X=46,Y=48,方向=3,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
	elseif 地图ID == 1206 then
    ...
    elseif 地图ID == 10002 or 地图ID == 10012 then --女儿村
        假人[1] ={名称="超级巫医",模型="男人_巫医",X=71,Y=89,方向=1,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
	    假人[2] ={名称="超级巫医",模型="男人_巫医",X=15,Y=46,方向=0,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
	    假人[3] ={名称="传送大使",模型="男人_马副将",X=60,Y=14,方向=1,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
	elseif 地图ID == 10003 or 地图ID == 10013 then --狮驼岭
     --    假人[1] ={名称="超级巫医",模型="男人_巫医",X=71,Y=89,方向=1,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
	    -- 假人[2] ={名称="超级巫医",模型="男人_巫医",X=15,Y=46,方向=0,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
	    假人[1] ={名称="传送大使",模型="男人_马副将",X=112,Y=78,方向=1,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
    elseif 地图ID == 10004 or 地图ID == 10014 then --墨家村
        假人[1] ={名称="超级巫医",模型="男人_巫医",X=18,Y=127,方向=0,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
	    假人[2] ={名称="超级巫医",模型="男人_巫医",X=70,Y=77,方向=1,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
	    假人[3] ={名称="传送大使",模型="男人_马副将",X=42,Y=13,方向=0,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
    elseif 地图ID == 10005 or 地图ID == 10015 then --花果山
        假人[1] ={名称="超级巫医",模型="男人_巫医",X=100,Y=103,方向=1,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
	    假人[2] ={名称="超级巫医",模型="男人_巫医",X=100,Y=59,方向=0,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
	    假人[3] ={名称="传送大使",模型="男人_马副将",X=82,Y=13,方向=0,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
    elseif 地图ID == 10006 or 地图ID == 10016 then --龙宫
        假人[1] ={名称="超级巫医",模型="男人_巫医",X=102,Y=74,方向=1,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
	    假人[2] ={名称="超级巫医",模型="男人_巫医",X=162,Y=43,方向=1,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
	    假人[3] ={名称="传送大使",模型="男人_马副将",X=190,Y=20,方向=1,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
    elseif 地图ID == 10007 or 地图ID == 10017 then --太岁府
        假人[1] ={名称="超级巫医",模型="男人_巫医",X=17,Y=41,方向=1,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
	    假人[2] ={名称="传送大使",模型="男人_马副将",X=10,Y=16,方向=1,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
    elseif 地图ID == 10008 or 地图ID == 10018 then --月宫
        假人[1] ={名称="传送大使",模型="男人_马副将",X=75,Y=16,方向=1,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
    elseif 地图ID == 10009 then
    	假人[1] ={名称="超级巫医",模型="男人_巫医",X=89,Y=85,方向=1,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
    elseif 地图ID == 2003 then
		假人[1] = {名称="猴爷爷",模型="长眉灵猴",X=115,Y=80,方向=0,任务显示=true,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
    elseif 地图ID == 2009 then
    	假人[1] ={名称="超级巫医",模型="男人_巫医",X=30,Y=27,方向=1,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
    	假人[2] ={名称="超级治疗师",模型="男人_酒店老板",X=50,Y=28,方向=1,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
    	假人[3] ={名称="竞技馆主持人",模型="男人_马副将",X=29,Y=38,方向=1,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
	elseif 地图ID == 5002 then
		...
		假人[34] = {名称="超级鲲鹏",模型="超级鲲鹏",X=131,Y=23,方向=0,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
	...
	elseif 地图ID == 1197 then --比武场
		假人[1] = {名称="比武大会传送人",模型="男人_将军",X=14,Y=55,方向=1,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
		假人[2] = {名称="传送人2号",模型="男人_老伯",X=101,Y=105,方向=1,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
	...
	elseif 地图ID == 5959 then
		假人[1] = {名称="钟馗分身",模型="男人_钟馗",X=102,Y=26,方向=0,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
	elseif 地图ID == 5960 then
		假人[1] = {名称="钟馗分身",模型="男人_钟馗",X=102,Y=26,方向=0,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
		
	elseif 地图ID >= 3000 and  地图ID <= 3150 then
		local mx = 雁塔地宫(地图ID-3000+1)
	...
	elseif 地图ID == 6033 then
		...
		假人[3] = {名称="修桃力士",模型="男人_打铁",X=94,Y=49,方向=3,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
	...
	elseif  地图ID == 5136 or 地图ID == 5137 or 地图ID == 5138 or 地图ID == 5139 then --比武场 --11.28
		假人[1] = {名称="比武大会卖药人",模型="男人_将军",X=64,Y=39,方向=1,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
	elseif 地图ID == 2514 then --会员地图
		假人[1] = {名称="超级神柚",模型="进阶超级神柚",X=74,Y=52,方向=0,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
		假人[2] = {名称="超级神柚",模型="进阶超级神柚",X=71,Y=41,方向=3,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
		假人[3] = {名称="超级神柚",模型="进阶超级神柚",X=52,Y=42,方向=2,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
		假人[4] = {名称="超级神柚",模型="进阶超级神柚",X=54,Y=52,方向=1,事件ID=nil,执行事件="不执行",小地图名称颜色=0}
	end
	if 假人ID==nil then
		return 假人
   	 else
